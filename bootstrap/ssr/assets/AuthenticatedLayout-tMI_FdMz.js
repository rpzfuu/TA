import { defineComponent, ref, onMounted, resolveComponent, unref, withCtx, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, useSSRContext } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li></ul></div></div></div><div class="flex min-h-screen"><aside class="bg-white shadow-lg w-72"><div class="flex flex-col p-4"><nav class="space-y-4">`);
      _push(ssrRenderComponent(unref(Link), {
        as: "button",
        href: _ctx.route("dashboard.index"),
        class: {
          ...
          if (_push2) {
            ...
            return [
              ...
              createVNode("span", { class: "font-medium" }, [
                unref(auth).user.is_spi ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                  createTextVNode("Input Temuan")
                ], 64)) : (openBlock(), createBlock(Fragment, { key: 1 }, [
                  createTextVNode("Input Tindak Lanjut")
                ], 64))
              ])
            ];
          }
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              ...
              createVNode("span", { class: "font-medium" }, [
                unref(auth).user.is_spi ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                  createTextVNode("Validasi bukti")
                ], 64)) : (openBlock(), createBlock(Fragment, { key: 1 }, [
                  createTextVNode("Cek Validasi")
                ], 64))
              ])
            ];
          }
